    ...
    def _embedding_kwargs(self) -> dict:
        ...
        if send_dimensions and "embedding_dimensions" in self.provider_config:
            try:
                ...
                logger.warning(
                    f"embedding_dimensions 不是合法整数: '{self.provider_config['embedding_dimensions']}'，已忽略。"
                )
        return kwargs
