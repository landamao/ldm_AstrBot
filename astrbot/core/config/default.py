            ...
            "provider": {
                ...
                "config_template": {
                    ...
                    "火山引擎生图": {
                        "id": "volcengine_image",
                        "provider": "volcengine",
                        "type": "volcengine_image_generation",
                        "provider_type": "image_generation",
                        "enable": True,
                        "key": [],
                ...
                "items": {
                    ...
                    "ark_model_family": {
                        "description": "火山模型能力族",
                        "type": "string",
                        "options": ["auto", "pro", "lite", "4.5", "4.0"],
                        "labels": ["按模型 ID 自动识别", "Seedream 5.0 pro", "Seedream 5.0 lite", "Seedream 4.5", "Seedream 4.0"],
                        "hint": "仅对当前模型生效。自动识别按该模型 ID 判断；手动选择优先于自动识别。Endpoint ID 或无法识别的模型需手动选择，不影响同一提供商下的其他模型。",
                    },
                    "ark_image_options": {
                        "description": "火山生图参数",
                        "type": "dict",
                        "items": {},
                        "hint": "可配置 size、watermark、response_format、output_format、optimize_prompt_options；lite 可配置 tools 联网搜索。组图数量是上限而非保证数量。pro 不支持组图/stream/tools；当前不支持 SSE 和图层拆分。缺省参数交由方舟处理，参数需符合实际模型能力。",
                        "template_schema": {
                            "size": {"name": "尺寸", "type": "string", "hint": "留空不发送尺寸，由模型决定；填写时可用当前模型支持的档位或宽x高。单次请求指定的尺寸优先。"},
                            "watermark": {"name": "图片水印", "type": "bool", "default": True},
                            "response_format": {"name": "响应格式", "type": "string", "default": "url", "hint": "url 或 b64_json，区别于图片编码格式。"},
                            "output_format": {"name": "图片编码格式", "type": "string", "default": "png", "hint": "添加时预设 png（无损编码），可改为 jpeg（有损编码）。仅 Seedream 5.0 pro/lite 支持；未添加时不发送该参数，使用方舟默认编码。"},
                        },
                    },
                    "custom_extra_body": {
                    ...
                    "embedding_dimensions_mode": {
                        "description": "嵌入维度发送模式",
                        "type": "string",
                        "options": ["auto", "always", "never"],
                        "default": "auto",
                        "hint": "auto：仅对已知支持的端点/模型发送 dimensions；always：总是发送；never：从不发送。",
                    },
                    "embedding_model": {
                        "description": "嵌入模型",
                        "type": "string",
            ...
            "ai": {
                ...
                "items": {
                    ...
                    "provider_settings.default_image_caption_provider_id": {
                        ...
                        "hint": "留空代表不使用，可用于非多模态模型。配置后会启用内置图片识别工具 ldmbot_image_caption，LLM 可主动调用该模型识别图片。",
                    },
            ...
            "ltm": {
                ...
                "items": {
                    ...
                    "provider_ltm_settings.group_message_history_max_cnt": {
                        ...
                        "type": "int",
                        "hint": "每个群最多保留的持久化消息条数。超出后删除最旧记录。",
                        "condition": {
