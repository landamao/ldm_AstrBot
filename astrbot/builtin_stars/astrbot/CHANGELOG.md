...
<details>
<summary><strong>[4.27.13] — 2026-08-28</strong> — 更新前自动备份与 --rollback 一键回滚、覆盖目录软链接安全处理</summary>
...
<details>
<summary><strong>[4.27.12] — 2026-08-28</strong> — ChatUI 主模型失败回退开关、模型请求错误折叠提示、版本切换降级警告、流式日志带出实际内容</summary>
...
<details>
<summary><strong>[4.26.39] — 2026-08-20</strong> — ChatUI 面板透明度统一、自定义壁纸开关、自定义 Logo、指令冲突详情查看</summary>
